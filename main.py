...
@click.command()
@click.option("--unity-env", default="./Reacher.app", help="Path to UnityEnvironment")
@click.option(
...
def main(unity_env, agent_cfg, no_graphics):
    ...
    #  TODO: get this information for environments other than Reacher,
    #   currently not done as to not clutter the click options
    trainer = AgentTrainer(score_window_size=100, score_threshold=30.0)
